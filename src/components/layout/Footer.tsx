...
const SocialIcon = ({ path }: { path: string }) => (
  <svg
    className="w-5 h-5 text-white hover:text-primary transition-all duration-300 cursor-pointer"
    fill="currentColor"
    viewBox="0 0 24 24"
...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#011c16] !text-white pt-16 pb-8 text-sm font-sans overflow-hidden border-t border-white/10 no-theme-change">
      {/* Royal Green Gradient Overlay */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_-20%,_#065f46_0%,_#011510_100%)] pointer-events-none" />

      <div className="relative z-10 w-full mx-auto px-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-12 mb-16">
        ...
        <div className="lg:col-span-5 sm:col-span-2 flex flex-col items-start gap-6">
          ...
          <p className="!text-white/80 leading-relaxed md:pr-8 font-body text-sm md:text-base">
        ...
        <div className="lg:col-span-3 sm:col-span-2">
          ...
          <div className="space-y-4 !text-white/80">
            ...
            <div className="flex gap-4 mt-6 flex-wrap items-center">
              {/* Facebook */}
              <a href="https://www.facebook.com/kamran.akram3/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
                <SocialIcon path="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z" />
              </a>
              {/* YouTube */}
              <a href="https://www.youtube.com/@MKamran09" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
              ...
              {/* Twitter/X */}
              <a href="https://x.com/mkamran09" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/in/kam09/" target="_blank" rel="noopener noreferrer" className="hover:scale-110 transition-transform">
      ...
      {/* --- Bottom Bar --- */}
      <div className="relative z-10 border-t border-white/10 max-w-7xl mx-auto px-6 pt-8 flex flex-col md:flex-row justify-between items-center text-xs !text-white/60 gap-4">
        {/* Left: Copyright */}
