...
// ---------------------------------------------------------------------------
const MailIcon = () => (
  <div className="flex items-center justify-center w-[60px] h-[60px] bg-[#ECF1FD] dark:bg-gray-800 rounded-md shadow-sm">
    <svg
  ...
  return (
    <button
      ...
      className="
        ...
        bg-gradient-to-b from-[#4480FF] via-[#115DFC] to-[#0550ED]
        rounded-md border-0 text-white font-semibold text-xs
        shadow-[0px_0.5px_0.5px_#EFEFEF,0px_1px_0.5px_rgba(239,239,239,0.5)]
      ...
      <form action={formAction} className="flex flex-col items-start p-5 gap-5">
        ...
        <div className="flex flex-col gap-2">
          <label
            ...
            className="font-bold text-[17px] leading-6 text-[#2B2B2F] dark:text-gray-100"
          >
        ...
        <input
          ...
          className="
            ...
            focus:border-transparent focus:ring-1 focus:ring-[#115DFC]
          "
        />
