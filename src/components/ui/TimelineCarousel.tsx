...
const TIMELINE_DATA: TimelineItem[] = [
  {
    ...
    description: "Selected for prestigious international fellowships, including Fulbright and Eisenhower. Broadened global perspective.",
    icon: <GlobalIcon />,
  },
  {
    yearRange: "2013 – 2016",
    title: "Global Impact",
    description: "Collaborated with governments and private sector teams on projects in AI, analytics, and policy innovation.",
    icon: <ImpactIcon />,
  },
  {
    yearRange: "2017 – 2025",
    title: "Sharing Knowledge",
    description: "Focused on teaching, writing, and mentoring. Launched learning initiatives and authored research books.",
    icon: <BookIcon />,
  },
  {
    yearRange: "2025 – 2030",
    title: "Future Vision",
    description: "Advancing AI and human centered systems for public good. Building ethical frameworks and global collaborations.",
    icon: <FutureIcon />,
  },
  {
    yearRange: "2030 – 2035",
    title: "Next Horizon",
    description: "Exploring quantum computing applications in social sciences and establishing new educational paradigms.",
    icon: <ImpactIcon />,
  },
  {
    yearRange: "2035+",
    title: "Legacy",
    description: "Creating sustainable foundations for future generations to build upon digital infrastructure.",
    icon: <GlobalIcon />,
  },
];
        ...
        <div className="flex flex-col flex-1 py-8 relative">
          ...
          <div className="flex items-center justify-between px-4 md:px-12 mb-6 gap-4">
            ...
            <button
              ...
              className={`flex items-center justify-center w-10 h-10 rounded-full transition-all duration-300 shadow-lg z-20 hover:scale-110 flex-shrink-0 ${activeIndex === 0 ? 'bg-gray-600 opacity-50 cursor-not-allowed' : 'bg-[#f59e0b] hover:bg-[#d97706] cursor-pointer'}`}
            >
              <svg className="h-5 w-5 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}><path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" /></svg>
            </button>
            ...
            <button
              ...
              className={`flex items-center justify-center w-10 h-10 rounded-full transition-all duration-300 shadow-lg z-20 hover:scale-110 flex-shrink-0 ${activeIndex === TIMELINE_DATA.length - 1 ? 'bg-gray-600 opacity-50 cursor-not-allowed' : 'bg-[#172716]/50 hover:bg-[#f59e0b] text-white hover:text-black cursor-pointer'}`}
            >
              ...
              {TIMELINE_DATA.map((item, index) => (
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="px-3 py-1 rounded-full border text-xs font-medium tracking-wide backdrop-blur-sm transition-all duration-300 whitespace-nowrap border-[#10b981]/50 bg-[#172716]/20 text-gray-500">
                      {item.yearRange}
                    </div>
                    <div className="p-2 rounded-lg transition-all duration-300 bg-gray-100 dark:bg-gray-800 text-gray-400">
                      {item.icon}
                    </div>
                  </div>

                  {/* Title */}
                  <h3 className="text-lg font-bold leading-snug mb-3 text-gray-600 dark:text-gray-400">
                    {item.title}
                  </h3>
