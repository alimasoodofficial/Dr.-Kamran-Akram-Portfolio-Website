...
export default function EbooksStoreClient({ initialEbooks }: EbooksStoreClientProps) {
  ...
  return (
    <div className="w-full space-y-12">
      ...
      <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md rounded-2xl p-6 border border-slate-200 dark:border-slate-800 shadow-lg   z-20 flex flex-col md:flex-row gap-6 items-center justify-between">
              ...
              {filteredAndSortedEbooks.map((book) => {
                ...
                return (
                  <motion.div
                    ...
                    className="group flex flex-col bg-white dark:bg-slate-900 rounded-2xl overflow-hidden shadow-md border border-slate-200 dark:border-slate-800 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1"
                  >
                    {/* Book Preview Header */}
                    <div className="bg-slate-200 dark:bg-slate-800 px-8 flex justify-center items-center relative overflow-hidden aspect-[4/3]">
                    ...
                    <div className="p-6 flex-1 flex flex-col justify-between bg-white dark:bg-slate-900">
                      <div className="space-y-4">
                        ...
                        <Link href={`/ebooks/${slugify(book.title)}`}>
                          <h3 className="font-extrabold text-xl text-slate-900 dark:text-white group-hover:text-emerald-500 transition-colors font-heading leading-snug">
                            {book.title}
                          </h3>
                        </Link>
                            ...
                            <>
                              ...
                              {hasActiveDiscount && (
                                <>
                                  ...
                                  <span className="px-2 py-0.5 text-[10px] font-bold rounded bg-emerald-100 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-400">
                                    {Math.round(((basePrice - activePrice) / basePrice) * 100)}% OFF
                                  </span>
                                </>
                              )}
                            </>
